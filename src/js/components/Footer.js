    ...
    <section className="Footer">
      <div className="container2">
        <div className="top">
          ...
          <div className="right">
            <ExternalLink className="facebook" href="https://www.facebook.com/RedRockDeli/">
              <span />
            </ExternalLink>
            <ExternalLink className="instagram" href="https://www.instagram.com/red_rock_deli/">
              <span />
            </ExternalLink>
          </div>
        </div>
        ...
        <div className="bottom">
          <div className="left">
            <Link to="/faq">FAQs</Link>|<Link to="/privacy-policy">Privacy Policy</Link>|
